/*
  Thanks to Sebastian Tabares Amaya (sytabaresa)
  Original code: https://github.com/sytabaresa/jsxgraph-react-js
*/
...
export default class JXGBoard extends Component {
  ...
  constructor(props) {
    super(props)
    this.id = 'board_' + Math.random().toString(36).substring(2, 11)
    this.state = { board: null }
    this.defaultStyle = { width: 500, height: 500 }
    this.defauflboardAttributes = {}

    // customized styles
    JXG.Options.text.cssStyle = 'font-family:serif;'
